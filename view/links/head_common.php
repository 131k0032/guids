  <head>
    ...
    <?php 
      ...
      $csslink = array(
         # -----------  Tab icon  -----------
        "http://localhost/guids/view/assets/images/favicon.ico", 
        # -----------  Fonts  -----------
        "http://localhost/guids/view/assets/fonts/icomoon/style.css", 
        "http://localhost/guids/view/assets/images/favicon.ico", 
        # -----------  Styles  -----------
        "http://localhost/guids/view/assets/css/bootstrap.min.css", 
        "http://localhost/guids/view/assets/css/magnific-popup.css", 
        "http://localhost/guids/view/assets/css/jquery-ui.css", 
        "http://localhost/guids/view/assets/css/owl.carousel.min.css", 
        "http://localhost/guids/view/assets/css/owl.theme.default.min.css", 
        "http://localhost/guids/view/assets/css/bootstrap-datepicker.css", 
        "http://localhost/guids/view/assets/css/aos.css", 
        "http://localhost/guids/view/assets/css/rangeslider.css",
        # -----------  Custom styles  ----------- 
        "http://localhost/guids/view/assets/css/style.css", 
        # -----------  Datatables  -----------
        "http://localhost/guids/view/datatables/css/dataTables.bootstrap4.min.css", 
        "http://localhost/guids/view/datatables/css/responsive.bootstrap4.min.css", 
        # -----------  Full Calendar  -----------  
        "http://localhost/guids/view/fullcalendar/core/main.css", 
        "http://localhost/guids/view/fullcalendar/bootstrap/main.css", 
