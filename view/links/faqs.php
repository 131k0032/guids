        ...
        <div class="col-md-8">
            ...
            <div class="collapse" id="collapse-1">
              <div class="pt-2">
                <p class="mb-0">Es una plataforma digital que conecta a guías locales con turistas y viajeros
                    ...
                    se sientan integrados en la realidad de lo que ven.
          ...
          <div class="border p-3 rounded mb-2">
              ...
              <div class="collapse" id="collapse-4">
                <div class="pt-2">
                  <p class="mb-0">Un Guids es sinónimo de “experiencias gratis”, es acompañar al turista por
                  las playas, rincones por la ciudad o comunidades, espacios públicos llenos de
                  arte, historia y gastronomía, donde el guía espera recibir al final, un donativo o
                  propina por su esfuerzo.</p>
                </div>
              </div>
            </div>
          <div class="border p-3 rounded mb-2">
              ...
              <div class="collapse" id="collapse-2">
                <div class="pt-2">
                  <p class="mb-0">El monto otorgado a los Guías lo determina el turista y viajero, no existe
                  precio establecido ni límite de pago. Las personas que disfruten de las
                  experiencias gratis, decidirán al final del tour la propina, esto dependerán de
                  cuanto les complació la experiencia y de sus medios económicos. <br>
                  La importancia que trae consigo el poder visitar los lugares más hermosos y
                  experiencias inolvidables a un costo bajo, abrimos la posibilidad de poder recorrer
                  el mundo y acceder a múltiples culturas. Brindamos oportunidades al guía local de
                  poder impulsar su economía y opción laboral, motivándoles a experiencias
                  divertidas e inolvidables.</p>
                </div>
              </div>
            </div>
        </div>
