  ...
  <?php 
      ...
      $jslink = array(
        # -----------  Main scripts  -----------   
        "http://localhost/guids/access-admin/view/assets/js/jquery-3.3.1.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/jquery-migrate-3.0.1.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/jquery-ui.js", 
        "http://localhost/guids/access-admin/view/assets/js/popper.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/bootstrap.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/owl.carousel.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/jquery.stellar.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/jquery.countdown.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/jquery.magnific-popup.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/bootstrap-datepicker.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/aos.js", 
        "http://localhost/guids/access-admin/view/assets/js/rangeslider.min.js", 
        "http://localhost/guids/access-admin/view/assets/js/typed.js", 
        "http://localhost/guids/access-admin/view/assets/js/main.js", 
        # -----------  Custom scripts  -----------  
        "http://localhost/guids/access-admin/view/assets/js/customStatesValues.js", 
        "http://localhost/guids/access-admin/view/assets/js/customTypedWords.js", 
        "http://localhost/guids/access-admin/view/assets/js/customDaysValues.js", 
        # -----------  Data tables  -----------  
        "http://localhost/guids/access-admin/view/datatables/js/jquery.dataTables.min.js", 
        "http://localhost/guids/access-admin/view/datatables/js/dataTables.bootstrap4.min.js", 
        "http://localhost/guids/access-admin/view/datatables/js/dataTables.responsive.min.js", 
        "http://localhost/guids/access-admin/view/datatables/js/responsive.bootstrap4.min.js", 
        # -----------  Fullcalendar  -----------   
        "http://localhost/guids/access-admin/view/fullcalendar/core/main.js", 
        "http://localhost/guids/access-admin/view/fullcalendar/daygrid/main.js", 
        "http://localhost/guids/access-admin/view/fullcalendar/list/main.js", 
        "http://localhost/guids/access-admin/view/fullcalendar/timegrid/main.js", 
        "http://localhost/guids/access-admin/view/fullcalendar/interactions/main.js", 
        "http://localhost/guids/access-admin/view/fullcalendar/bootstrap/main.js", 
