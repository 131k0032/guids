	...
	// AquÃ­ van los datos que apareceran en el correo que reciba
	   ...
	   // Datos del servidor SMTPs
	    ...
	    if ($mail->Send()){	    	
	    	...
	    	print "<script>alert(\"SEND.\");window.location='http://localhost/guids/access-admin/newusers';</script>";
	    	 echo "SCUEESS: " . $mail->ErrorInfo;
	    }					    
	    else{
	    	// print "<script>alert(\"Error al enviar Email\");window.location='https://guids.mx/access-admin/newusers';</script>";	
	    	print "<script>alert(\"NO SEND.\");window.location='http://localhost/guids/access-admin/newusers';</script>";
