        ...
        jqbar: function (options) {
            ...
            return this.each(function () {
                ...
                if (settings.orientation == 'h') {
                    ...
                    progressContainer.addClass('jqbar horizontal').append('<span class="bar-label"></span><span class="bar-level-wrapper"><span class="bar-level" style="border-radius:25px;"></span></span><span class="bar-percent"></span>');
