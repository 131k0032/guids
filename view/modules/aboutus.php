...
<div class="py-5 bg-primary">
  <div class="container">
    <div class="row text-center">
      <div class="col-md-12">
        <h2 class="mb-2 text-white">Vamos a comenzar. Adelante, crea tu cuenta</h2>
        <!-- <p class="mb-4 lead text-white-opacity-05">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, fugit?</p> -->
        <p class="mb-0"><a href="http://localhost/guids/signup" class="btn btn-outline-white text-white btn-md font-weight-bold">Registro</a></p>
      </div>
    </div>
  </div>
</div>    
